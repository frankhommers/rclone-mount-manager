...
public class SizeSuffixHelperTests
{
  ...
  {
    (decimal value, string unit) = SizeSuffixHelper.Parse(input);
  ...
  {
    (decimal value, string unit) = SizeSuffixHelper.Parse(null);
  ...
  {
    IReadOnlyList<string> units = SizeSuffixHelper.Units;
